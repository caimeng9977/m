# 封装：将类的属性，方法进行封装，隐藏不对外界暴露，使用私有属性和私有方法
class Class(object):
...
# print(ai2.cls_name, Class.cls_name)   # 实例属性，类不能访问，只有这个实例对象可以访问
# 访问保护属性， 私有属性
# print(ai2.__job, Class.job) # 保护属性如果和公有属性对象可以访问，类不能访问实例属性
# print(ai2.__hobby, Class.__hobby)   #私有属性，只能类内 访问
# 可以通过类内定义的实例方法访问

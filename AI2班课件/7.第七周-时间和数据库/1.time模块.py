...
"""
# 1.time():可以获取当前的时间戳
# 时间戳：就是从1970年1月1日0：0：0开始到现在这一时刻的总秒数，浮点数，小数点后精确7位
tt = time.time()
print(tt)
# 2.localtime():获取本地的时间，是一个时间元组
# tm_year=2022,tm_mon=4,tm_mday=12,tm_hour=11,tm_min=23,tm_sec=32,tm_wday=1,tm_yday=102,tm_isdst=0
...
ctime = time.ctime()
print(ctime)
# 9.gmtime():获取当前时间，表示为计算机课处理的时间格式，
